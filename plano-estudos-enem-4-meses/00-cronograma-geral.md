# Cronograma geral de 16 semanas

## Visao dos 4 meses

| Mes | Objetivo principal | Entrega minima |
|---|---|---|
| 1 | Base teorica e diagnostico | 1 simulado diagnostico, 4 redacoes, caderno de erros iniciado. |
| 2 | Aprofundamento dos principais conteudos | 2 simulados, 4 redacoes, aumento de questoes. |
...
|---:|---|---|---|---:|---:|---|
| 1 | Matematica: razao, proporcao, porcentagem; Linguagens: interpretacao; Humanas: Brasil Colonia; Natureza: ecologia | Matematica basica, leitura | Diagnostico de pontos fracos | 1 | 50 | Revisar erros no domingo |
| 2 | Regra de tres, graficos, generos textuais, escravidao, cadeias alimentares | Matematica, Humanas | Criar caderno de erros | 1 | 60 | Revisao curta de semana 1 |
| 3 | Estatistica, funcoes da linguagem, Brasil Imperio, ciclos biogeoquimicos, solucoes | Linguagens, Natureza | 1 bloco de questoes por area | 1 | 70 | Simulado diagnostico parcial |
| 4 | Equacoes, coesao, Republica Velha, genetica, mecanica basica | Matematica, Natureza | Fechar lacunas do mes | 1 | 80 | Revisao mensal completa |
| 5 | Funcoes, literatura brasileira, Era Vargas, urbanizacao, estequiometria | Matematica, Humanas | Questao comentada todo dia | 1 | 90 | Simulado quinzenal |
| 6 | Geometria plana, variacao linguistica, Ditadura Militar, globalizacao, eletricidade | Matematica, Humanas | Corrigir simulado por habilidade | 1 | 100 | Revisar erros recorrentes |
| 7 | Geometria espacial, textos multimodais, Guerra Fria, clima, quimica ambiental | Natureza, Linguagens | Lista mista por area | 1 | 110 | Simulado quinzenal |
| 8 | Probabilidade, modernismo, movimentos sociais, energia, fisiologia humana | Matematica, Redacao | Reescrever uma redacao antiga | 1 | 120 | Revisao mensal |
| 9 | Provas antigas de matematica e linguagens; saude publica; geografia ambiental | Questoes | Resolver por tempo | 2 | 140 | Simulado semanal |
| 10 | Humanas contextualizadas, eletroquimica, dinamica, literatura e artes | Humanas, Natureza | Corrigir 30 erros antigos | 2 | 150 | Simulado semanal |
| 11 | Graficos, tabelas, cidadania, trabalho, optica, biotecnologia | Matematica, Redacao | Treino de estrategia de prova | 2 | 160 | Simulado semanal |
| 12 | Revisao dirigida dos temas com menor acerto | Pontos fracos | Lista personalizada | 2 | 170 | Simulado semanal e revisao mensal |
| 13 | Revisao de alta prioridade: matematica basica, interpretacao, ecologia, Brasil Republica | Revisao final | Flashcards e questoes antigas | 2 | 180 | 1 simulado completo |
| 14 | Redacao, natureza aplicada, humanas com atualidades, geometria | Tempo de prova | Treinar ordem de resolucao | 2 | 180 | 1 a 2 simulados |
| 15 | Revisao por competencias e matriz: linguagens, matematica, natureza, humanas | Precisao | Refazer questoes erradas | 2 | 160 | 1 simulado completo |
| 16 | Revisao leve, repertorios, formulas, descanso ativo | Consolidacao | Planejar dia da prova | 2 | 100 | Simulado final no inicio da semana |

## Regra de revisao

- Revisao de 24 horas: rever erros do dia anterior.
