...
|---|---|---|---|---|---|---|
| Ecologia | Alta | Cadeias, teias, niveis troficos | Fluxo de energia | Impactos ambientais | Bioacumulacao em rios | Siga a energia na cadeia |
| Ciclos biogeoquimicos | Alta | Carbono, nitrogenio, agua | Ciclagem da materia | Mudancas climaticas | Queima de combustiveis | Relacione acao humana |
| Genetica | Media | Heranca, DNA, biotecnologia | Probabilidades simples | Doencas e melhoramento | Transgenicos | Monte cruzamentos |
| Evolucao | Media | Selecao natural e adaptacao | Variabilidade | Resistencia bacteriana | Uso de antibioticos | Evite ideia de progresso |
| Citologia e fisiologia | Media | Membrana, organelas, sistemas | Homeostase | Saude humana | Diabetes, vacinas | Foque funcao |
| Saude publica | Alta | Vacinas, doencas, saneamento | Prevencao | Campanhas e dados | Dengue e saneamento | Leia indicadores |

## Quimica

| Assunto | Prioridade | Conceitos principais | Formulas importantes | Como o ENEM cobra | Exemplo contextualizado | Dica |
|---|---|---|---|---|---|---|
| Estequiometria | Alta | Mol, massa, proporcao | n=m/M | Processos industriais | Producao de fertilizantes | Balanceie antes |
| Quimica ambiental | Alta | Poluicao, tratamento, agua | pH, concentracao | Impactos e solucoes | Chuva acida | Pense causa e efeito |
| Solucoes | Alta | Concentracao, diluicao | C=m/V; C1V1=C2V2 | Medicamentos e agua | Soro fisiologico | Confira unidades |
| Separacao de misturas | Media | Filtracao, destilacao, decantacao | Propriedades fisicas | Tratamento de agua | Petroleo | Associe propriedade ao metodo |
| Ligacoes e reacoes | Media | Ionica, covalente, balanceamento | Conservacao da massa | Materiais | Corrosao | Identifique substancias |
| Organica, eletroquimica, termoquimica e radioatividade | Media | Funcoes, pilhas, calor, radiacao | Energia e oxidacao | Combustiveis, baterias, medicina | Etanol e pilhas | Foque aplicacao |

## Fisica

| Assunto | Prioridade | Conceitos principais | Formulas importantes | Como o ENEM cobra | Exemplo contextualizado | Dica |
|---|---|---|---|---|---|---|
| Mecanica e cinematica | Alta | Movimento, velocidade, aceleracao | v=d/t; s=s0+vt | Transporte e graficos | Velocidade media | Leia unidades |
| Dinamica | Media | Forca, massa, aceleracao | F=m.a | Atrito e seguranca | Cinto de seguranca | Desenhe forcas |
| Energia, trabalho e potencia | Alta | Conservacao, rendimento | E=mgh; P=E/t | Consumo e maquinas | Conta de energia | Compare grandezas |
